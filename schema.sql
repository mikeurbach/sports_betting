-- MySQL dump 10.13  Distrib 5.6.22, for debian-linux-gnu (i686)
--
...
CREATE TABLE `money_line` (
  ...
  `home_line` decimal(10,5) NOT NULL,
  `away_line` decimal(10,5) NOT NULL,
  `draw_line` decimal(10,5) NOT NULL,
...
-- Dump completed on 2015-01-23 21:16:00
